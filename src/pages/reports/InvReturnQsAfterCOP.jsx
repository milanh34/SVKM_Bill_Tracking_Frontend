...
import { courieredMumbai, invReturnQsCop } from '../../apis/report.api';
...
const InvReturnQsAfterCOP = () => {
    ...
    useEffect(() => {
        ...
        const fetchBills = async () => {
            ...
            try {
                const response = await axios.get(`${invReturnQsCop}?startDate=${fromDate}&endDate=${toDate}`);
    ...
    const columns = [
        ...
        { field: "dateReturnedByQS", headerName: "Dt ret-PIMO by QS Mumbai" }, // column no 66
    ]
                                ...
                                : bills
                                    ...
                                    .map((bill, index) => (
                                        <tr key={index} className="hover:bg-[#f5f5f5]">
                                            ...
                                            <td className='border border-black text-[14px] py-[0.75vh] px-[0.65vw] text-right'>{bill.dateReturnedByQS}</td>
                                        </tr>
                                    ))}
                            {bills
...
export default InvReturnQsAfterCOP;