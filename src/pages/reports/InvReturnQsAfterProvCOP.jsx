...
const InvReturnQsAfterMeasurement = () => {
    ...
    useEffect(() => {
        ...
        const fetchBills = async () => {
            ...
            try {
                const response = await axios.get(`${invReturnQsProvCop}?startDate=${fromDate}&endDate=${toDate}`);
    ...
    const columns = [
        ...
        { field: "dateDispatchedForPimo", headerName: "Dt ret-QS aft Prov COP" }, // column no 44A
    ]
                    ...
                    <table className='w-full border-collapse bg-white'>
                        <thead>
                            <tr>
                                ...
                                <th className='sticky top-0 z-[1] border border-black bg-[#f8f9fa] font-bold text-[#333] text-[16px] py-[1.5vh] px-[1vw] text-left'>Dt return-QS after Prov COP</th>
                            </tr>
                        </thead>
                        <tbody>
                            {loading ? (
...
export default InvReturnQsAfterMeasurement;