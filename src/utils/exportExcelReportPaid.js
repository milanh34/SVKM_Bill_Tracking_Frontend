...
export const handleExportRepPaid = async (selectedRows, filteredData, columns, visibleColumnFields, toPrint) => {
    try {
        ...
        if (toPrint) {
            ...
            printWindow.document.write("<html><head><title>Invoices Paid</title></head><body>");
            // printWindow.document.write("<h2>Invoices Paid</h2>");
            ...
            printWindow.document.write(`<th colSpan='8'>Invoices Paid:</th>`);
            printWindow.document.write(`</tr>`);
            // printWindow.document.write(`<th>Invoices Paid</th>`);
            allColumnsToExport.forEach((column) => {
