...
export const handleExportRepRecdAtMumbai = async (selectedRows, filteredData, columns, visibleColumnFields, toPrint) => {
    try {
        ...
        if (toPrint) {
            ...
            printWindow.document.write("<html><head><title>Invoices received at Mumbai</title></head><body>");
            // printWindow.document.write("<h2>Invoices received at Mumbai</h2>");
            ...
            printWindow.document.write(`<th colSpan='8'>Invoices received at Mumbai:</th>`);
            printWindow.document.write(`</tr>`);
            // printWindow.document.write(`<th>Invoices received at Mumbai</th>`);
            allColumnsToExport.forEach((column) => {
