...
export const handleExportRepCourierToMumbai = async (selectedRows, filteredData, columns, visibleColumnFields, toPrint) => {
    try {
        ...
        if (toPrint) {
            ...
            printWindow.document.write("<html><head><title>Invoices courier to mumbai</title></head><body>");
            // printWindow.document.write("<h2>Invoices courier to mumbai</h2>");
            ...
            printWindow.document.write(`<th colSpan='8'>Invoices courier to mumbai:</th>`);
            printWindow.document.write(`</tr>`);
            // printWindow.document.write(`<th>Invoices courier to mumbai</th>`);
            allColumnsToExport.forEach((column) => {
