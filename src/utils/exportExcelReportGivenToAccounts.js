...
export const handleExportRepGivenToAccounts = async (selectedRows, filteredData, columns, visibleColumnFields, toPrint) => {
    try {
        ...
        if (toPrint) {
            ...
            printWindow.document.write("<html><head><title>Invoices given to Accts Dept</title></head><body>");
            // printWindow.document.write("<h2>Invoices given to Accts Dept</h2>");
            ...
            printWindow.document.write(`<th colSpan='8'>Invoices given to Accts Dept:</th>`);
            printWindow.document.write(`</tr>`);
            // printWindow.document.write(`<th>Invoices given to Accts Dept</th>`);
            allColumnsToExport.forEach((column) => {
