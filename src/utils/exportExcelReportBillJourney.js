...
export const handleExportRepBillJourney = async (selectedRows, filteredData, columns, visibleColumnFields, toPrint) => {
    try {
        ...
        if (toPrint) {
            ...
            printWindow.document.write("<html><head><title>Bill Journey</title></head><body>");
            // printWindow.document.write("<h2>Bill Journey</h2>");
            ...
            printWindow.document.write(`<th colSpan='7'>Bill Journey:</th>`);
            printWindow.document.write(`</tr>`);
            // printWindow.document.write(`<th>Bill Journey</th>`);
            allColumnsToExport.forEach((column) => {
