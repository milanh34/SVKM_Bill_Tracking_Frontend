...
export const handleExportRepPendingBills = async (selectedRows, filteredData, columns, visibleColumnFields, toPrint) => {
    try {
        ...
        if (toPrint) {
            ...
            printWindow.document.write("<html><head><title>Reports of pending bills with PIMO/SVKM site office/QS Mumbai office/QS site office</title></head><body>");
            // printWindow.document.write("<h2>Reports of pending bills with PIMO/SVKM site office/QS Mumbai office/QS site office</h2>");
            ...
            printWindow.document.write(`<th colSpan='7'>Reports of pending bills with PIMO/SVKM site office/QS Mumbai office/QS site office:</th>`);
            printWindow.document.write(`</tr>`);
            // printWindow.document.write(`<th>Reports of pending bills with PIMO/SVKM site office/QS Mumbai office/QS site office</th>`);
            allColumnsToExport.forEach((column) => {
