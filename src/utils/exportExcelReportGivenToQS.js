...
export const handleExportRepGivenToQS = async (selectedRows, filteredData, columns, visibleColumnFields, toPrint) => {
    try {
        ...
        if (toPrint) {
            ...
            printWindow.document.write("<html><head><title>Invoices given to QS Site</title></head><body>");
            // printWindow.document.write("<h2>Invoices given to QS Site</h2>");
            ...
            printWindow.document.write(`<th colSpan='8'>Invoices given to QS Site:</th>`);
            printWindow.document.write(`</tr>`);
            // printWindow.document.write(`<th>Invoices given to QS Site</th>`);
            allColumnsToExport.forEach((column) => {
