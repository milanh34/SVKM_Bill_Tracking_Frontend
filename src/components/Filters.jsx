...
const Filters = ({
    ...
    return (
        <div className="flex justify-between mb-3 items-center bg-transparent md:flex-nowrap md:gap-[2vh] md:pl-8">
            {(searchQuery !== undefined || vendorName !== undefined || taxInvNo !== undefined || sortBy !== undefined) ? (
                <div className="flex gap-3 items-center z-[21] bg-transparent w-[66%] md:w-[60%]">
                    ...
                    {searchQuery !== undefined && (
                        <div className="flex bg-white min-h-[32px] w-full rounded-md border border-[#cacaca] p-1 hover:border-[#c0c0c0] hover:bg-[#fafafa]">
                    ...
                    {vendorName !== undefined && (
                        <div className="flex bg-white min-h-[32px] w-full rounded-md border border-[#cacaca] p-1 hover:border-[#c0c0c0] hover:bg-[#fafafa]">
                            ...
                            <input
                                ...
                                value={vendorName}
                                onChange={(e) => setVendorName && setVendorName(e.target.value)}
                            />
                        </div>
                    )}
                    ...
                    {taxInvNo !== undefined && (
                        <div className="flex bg-white min-h-[32px] w-full rounded-md border border-[#cacaca] p-1 hover:border-[#c0c0c0] hover:bg-[#fafafa]">
                            ...
                            <input
                                ...
                                value={taxInvNo}
                                onChange={(e) => setTaxInvNo && setTaxInvNo(e.target.value)}
                            />
                        </div>
                    )}
