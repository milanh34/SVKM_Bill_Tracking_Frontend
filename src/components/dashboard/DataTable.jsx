...
const DataTable = ({
  ...
  const handleEditClick = async (row) => {
    if (editingRow === row._id) {
      ...
      console.log("Edit initialized — visible fields:", visibleColumnFields);
      console.log("Edit initialized — includes advance?",
        visibleColumnFields.includes("advanceDate"),
        visibleColumnFields.includes("advanceAmt"),
        visibleColumnFields.includes("advancePercentage")
      );
      console.log("Row advance values:", {
        advanceDate: row.advanceDate,
        advanceAmt: row.advanceAmt,
